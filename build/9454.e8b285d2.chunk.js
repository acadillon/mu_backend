...
`,fs=({headers:e=[],label:t})=>{const{formatMessage:o}=(0,K.A)();return(0,s.jsxs)(m.s,{children:[(0,s.jsx)(m.s,{width:xe,height:de,shrink:0,alignItems:"center",paddingLeft:6,children:(0,s.jsx)(O.o,{variant:"sigma",textColor:"neutral500",children:o({id:"Settings.roles.form.permission.property-label",defaultMessage:"{label} permissions"},{label:t})})}),e.map(n=>n.isActionRelatedToCurrentProperty?(0,s.jsx)(m.s,{width:F,shrink:0,justifyContent:"center",children:(0,s.jsx)(O.o,{variant:"sigma",textColor:"neutral500",children:o({id:`Settings.roles.form.permissions.${n.label.toLowerCase()}`,defaultMessage:n.label})})},n.label):(0,s.jsx)(m.s,{width:F,shrink:0},n.label))]})},oe=e=>(0,L.css)`
  ${O.o} {

...
export interface ApiAboutAbout extends Schema.CollectionType {
  ...
  attributes: {
    ...
    BodyEN: Attribute.Blocks;
    BioEN: Attribute.Blocks;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiMenuMenu extends Schema.SingleType {
  ...
  attributes: {
    Works: Attribute.Relation<'api::menu.menu', 'oneToMany', 'api::work.work'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiWorkWork extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Body: Attribute.Blocks;
    work: Attribute.Relation<'api::work.work', 'manyToOne', 'api::work.work'>;
    works: Attribute.Relation<'api::work.work', 'oneToMany', 'api::work.work'>;
    TitleEN: Attribute.String;
    BodyEN: Attribute.Blocks;
    Credit: Attribute.Blocks;
    TypeDeProjet: Attribute.String;
    TypeDeProjetEN: Attribute.String;
    Poem: Attribute.Blocks;
    PoemEN: Attribute.Blocks;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
